  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground transition-transform duration-300 ease-in-out",
            className,
          )}
          ref={ref}
          {...props}
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:block transition-transform duration-300 ease-in-out"
        data-state={state}
